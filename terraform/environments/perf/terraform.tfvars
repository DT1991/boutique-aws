...
secondary_vpc_cidr             = "10.14.0.0/16"
secondary_availability_zones   = ["us-east-1a", "us-east-1b", "us-east-1c"]
secondary_system_node_desired  = 1
secondary_system_node_min      = 1
secondary_system_node_max      = 2
secondary_app_node_desired     = 2
secondary_app_node_min         = 1
secondary_app_node_max         = 10
